...
public class AddProductViewModel : INotifyPropertyChanged
{
    ...
    public AddProductViewModel(ProductDataService productDataService)
    {
    ...
    private async Task SaveProductAsync()
    {
        ...
        try
        {
            ...
            _productDataService.AddProduct(product);

            await Shell.Current.DisplayAlert("Success", $"Product '{Name}' added successfully!", "OK");
