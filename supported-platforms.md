...
**.NET Multi-platform App UI (.NET MAUI)** enables developers to build applications for the following platforms:
- **Android**: .NET MAUI supports Android versions 5.0 (Lollipop) (API 21) and higher.
- **iOS**: Version 12.2 or higher is supported for iOS applications.
- **macOS**: Version 12 or higher, using _Mac Catalyst_.
- **Windows**: Windows 11 and Windows 10 (version 1809 or later), using __WinUI 3__.

#### Additional Requirements for .NET MAUI Blazor Apps
